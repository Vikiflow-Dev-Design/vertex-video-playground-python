...
- If I do NOT provide a style block along with the clips, use this DEFAULT
  style on every prompt instead:
    ...
    STYLE: full-body, low-poly 3D-rendered digital image, with angular
    surfaces and sharp shadows, stylized like a video game cinematic or
    Unreal Engine cutscene, exaggerated polygonal features, minimal facial
    detail, clean, flat color shading, 3D polygonal style, low poly, low
    polygonal
